...
import reaktive.config.Constants.PROP_MAIL_BASE_URL
import reaktive.config.Constants.PROP_MAIL_FROM
import reaktive.config.Constants.PROP_MAIL_HOST
import reaktive.config.Constants.PROP_MAIL_PASSWORD
import reaktive.config.Constants.PROP_MAIL_PORT
import reaktive.config.Constants.PROP_MAIL_PROPERTY_DEBUG
import reaktive.config.Constants.PROP_MAIL_PROPERTY_SMTP_AUTH
import reaktive.config.Constants.PROP_MAIL_PROPERTY_SMTP_STARTTLS_ENABLE
import reaktive.config.Constants.PROP_MAIL_PROPERTY_TRANSPORT_PROTOCOL
