...
import reaktive.config.Constants.AUTHORITIES_KEY
import reaktive.config.Constants.INVALID_TOKEN
import reaktive.config.Constants.VALID_TOKEN
                    ...
                    if (!hasLength(this))
                        log.warn(
                            "Warning: the JWT key used is not Base64-encoded. " +
                                    "We recommend using the `reaktive.security.authentication.jwt.base64-secret`" +
