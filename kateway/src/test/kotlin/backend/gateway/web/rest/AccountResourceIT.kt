package backend.gateway.web.rest

import backend.gateway.IntegrationTest
import backend.gateway.config.DEFAULT_LANGUAGE
import backend.gateway.config.SYSTEM_ACCOUNT
import backend.gateway.domain.User
import backend.gateway.repository.AuthorityRepository
import backend.gateway.repository.UserRepository
import backend.gateway.security.ADMIN
import backend.gateway.security.USER
import backend.gateway.service.UserService
import backend.gateway.service.dto.AdminUserDTO
import backend.gateway.service.dto.PasswordChangeDTO
import backend.gateway.web.rest.vm.KeyAndPasswordVM
import backend.gateway.web.rest.vm.ManagedUserVM
