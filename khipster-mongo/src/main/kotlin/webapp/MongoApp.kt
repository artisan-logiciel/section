...
import webapp.config.ApplicationProperties
...
class MongoApp(private val env: Environment) {

    private val log = LoggerFactory.getLogger(javaClass)

    /**
     * Initializes MongoApp.
     *
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<MongoApp>(*args) { DefaultProfileUtil.addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(MongoApp::class.java)
